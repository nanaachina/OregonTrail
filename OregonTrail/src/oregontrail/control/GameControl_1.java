...
import oregontrail.view.Person;
...
public class GameControl {
    ...
    private static List<Person> actors = new ArrayList<>();
     ...
     */
    public static int createPerson(Person actor) {
        //Check if the actor is valid        
        if (isPersonValid(actor)) {
    ...
    private static boolean isPersonValid(Person actor) {
        if (actor == null) {
            return false;
        }
